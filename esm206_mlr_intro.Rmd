...
When we perform multiple linear regression, we are trying to understand the relationship between multiple predictor variables (continuous or categorical), and a single continuous output variable. Make sure to watch the Week 8 lecture (and read the accompanying document) to learn more. 
...
library(broom)
library(kableExtra)
library(stargazer) # May need to install this one
...
##### Overall mdel fit and significance
...
### 5. Communicate results of your model
